...
export const MOCK_USERS: User[] = [
  { id: '1', username: 'admin', fullName: 'Administrador Maestro', password: 'admin', role: UserRole.ADMIN, organization: 'Gestión de Sellos Global', city: 'Bogotá' },
  { id: '2', username: 'gestor_medellin', fullName: 'Carlos Medellin', password: 'admin', role: UserRole.GESTOR, organization: 'Gestión de Sellos Global', city: 'Medellín' },
  { id: '3', username: 'gestor_bogota', fullName: 'Juan Bogota', password: 'admin', role: UserRole.GESTOR, organization: 'Gestión de Sellos Global', city: 'Bogotá' },
];
